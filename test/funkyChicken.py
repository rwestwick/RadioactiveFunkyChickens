...
def startServod():
    ...
    initString = "sudo " + SCRIPTPATH + \
        '/servod --pcm --idle-timeout=20000 --p1pins="18,22" > /dev/null'
...
# getDistance(). Returns the distance in cm to the nearest reflecting
# object. 0 == no object
def getDistance():
...
# runningAvg(nextValue): Maintains a running average of the last
# lengthOfList nextValues
